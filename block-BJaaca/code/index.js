...
// - Add another property named `greet` and value should be a function when called should
//  alert `I am [NAME HERE] and my title is [TITLE HERE]`.
...
function greet(){}
greet(alert(`I am ${character.characterName + character.surname} and my title is ${character.title}`));

//  - Change the method `greet` to now alert `She is [NAME HERE] and her title is [TITLE HERE]`.

character.greet = alert(`She is ${character.characterName + character.surname} and her title is ${character.title}`);
